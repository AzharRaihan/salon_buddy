            ...
            <VCardText>
                ...
                <div class="report-header">
                    ...
                    <div class="d-flex justify-space-between align-center mb-6">
                        <div v-if="reportHeaderData.employeeName || reportHeaderData.employeePhone">
                            <div v-if="reportHeaderData.employeeName" class="text-body-1 text-medium-emphasis">
...
const { formatDate, formatDateWithTime } = useCompanyFormatters()
...
const reportHeaderData = computed(() => {
    const headerData = {
        ...
        employeeName: props.selectedEmployeeName !== 'All Employees' ? props.selectedEmployeeName : null,
        employeePhone: props.selectedEmployee?.phone || null,
