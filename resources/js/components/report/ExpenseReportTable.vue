                ...
                <div class="report-header">
                    ...
                    <div class="d-flex justify-space-between align-center mb-6">
                        <div>
                            ...
                            <div v-if="reportHeaderData.categoryName" class="text-body-1 text-medium-emphasis mt-2">
                                Category: {{ reportHeaderData.categoryName }}
                            </div>
                        </div>
                        <div>
                            <div class="text-body-1 text-medium-emphasis">
...
const reportHeaderData = computed(() => {
    const headerData = {
        ...
        categoryName: props.selectedCategoryName !== 'All Categories' ? props.selectedCategoryName : null,
