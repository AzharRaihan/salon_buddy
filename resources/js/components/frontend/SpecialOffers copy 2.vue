    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <!-- <div class="col-md-6 col-xl-4 pd-0">
              <div class="about-list-right">
                <figure>
                  <img src="https://salon.hnaxes.com/application/uploads/img/spa1.jpg" alt="">
                </figure>
                <div class="content">
                  <h4>Summer Package</h4>
                  <div class="serviceInfoMain">
                    <div class="media">
                      <VIcon icon="tabler-clock" size="24" class="serviceInfoicon" />
                      <div class="media-body">
                        <p class="serviceInfoHeading">Duration:</p>
                        <p class="serviceInfoValue ps-1">02:00</p>
                      </div>
                    </div>
                    <div class="media mb-3">
                      <VIcon icon="tabler-premium-rights" size="24" class="serviceInfoicon" />
                      <div class="media-body">
                        ...
                        <p class="serviceInfoValue ps-1">$10</p>
                      </div>
                    </div>
                    <div class="attached-services">
                      <ul>
                        ...
                        <li>
                          ...
                          <span class="included-service-name pe-2">
                            Body Massage
                          </span>
                          <span>
                            (2x)
                    ...
                    <a href="#home" class="booknowBtn btn3" data-value="26"><span>Book Now</span></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-xl-4 pd-0">
              <div class="about-list-right">
                <figure>
                  <img src="https://salon.hnaxes.com/application/uploads/img/haircut51.jpg" alt="">
                </figure>
                <div class="content">
                  <h4>Summer Package</h4>
                  <div class="serviceInfoMain">
            ...
            <div class="col-md-6 col-xl-4 pd-0">
              <div class="about-list-right">
                <figure>
                  <img src="https://salon.hnaxes.com/application/uploads/img/hairdesign41.jpg" alt="">
                </figure>
                <div class="content">
                  <h4>Summer Package</h4>
                  <div class="serviceInfoMain">
            ...
            <div class="col-md-6 col-xl-4 pd-0">
              <div class="about-list-right">
                <figure>
                  <img src="https://salon.hnaxes.com/application/uploads/img/makeup6.jpg" alt="">
                </figure>
                <div class="content">
                  <h4>Summer Package</h4>
                  <div class="serviceInfoMain">
      ...
      <div class="row">
        ...
        <div v-if="showViewAllButton" class="col-12 text-center mt-0">
          <SectionMoreBtn :link="'/package'" :text="'View All Packages'" :icon="'tabler-arrow-narrow-right'" />
        </div>
