<template>
  <section class="featured-services default-section-padding">
    <div class="container">
      <div class="row">
        <div class="col-12">
      ...
      <div class="features-service-swiper-wrap">
        <div class="swiper featured-services-swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide" v-for="service in featuredServices" :key="service.id">
...
const fetchFeaturedServices = async (categoryId = 'all') => {
  try {
    ...
    if (response.success) {
      ...
      // Wait for DOM update, then reinit swiper
      nextTick(() => {
        if (swiperInstance) {
