...
import { hasAnyPermission, canViewNavItem } from '@/utils/permissions'
...
// Check if the section title should be visible based on permissions
const isVisible = computed(() => {
  return canViewNavItem(props.item)
})
</script>

<template>
  <li v-if="isVisible" class="nav-section-title">
