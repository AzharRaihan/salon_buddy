...
import { hasAnyPermission, canViewNavGroup } from '@/utils/permissions'
...
// Check if the group should be visible based on permissions and children
const isVisible = computed(() => {
  return canViewNavGroup(props.item)
})
...
<template>
  <li v-if="isVisible" class="nav-group" :class="[
    {
