...
export const isNavLinkActive = (link, router) => {
  ...
  // Define create/edit route mappings for navigation active states
  // This allows "Add" navigation items to be active when on their corresponding edit routes
  const createEditRouteMap = {
    // Item & Stock Management
    'item-create': ['item-create', 'item-edit'],
    'unit-create': ['unit-create', 'unit-edit'],
    'category-create': ['category-create', 'category-edit'],
    
    // Branch & Booking
    'branch-create': ['branch-create', 'branch-edit'],
    'booking-create': ['booking-create', 'booking-edit'],
    
    // Sales & Customers
    'customer-create': ['customer-create', 'customer-edit'],
    'customer-receive-create': ['customer-receive-create', 'customer-receive-edit'],
    'promotion-create': ['promotion-create', 'promotion-edit'],
    
    // Purchase & Suppliers
    'purchase-create': ['purchase-create', 'purchase-edit'],
    'supplier-create': ['supplier-create', 'supplier-edit'],
    'supplier-payment-create': ['supplier-payment-create', 'supplier-payment-edit'],
    
    // Expense Management
    'expense-create': ['expense-create', 'expense-edit'],
    'expense-category-create': ['expense-category-create', 'expense-category-edit'],
    
    // Accounting
    'payment-method-create': ['payment-method-create', 'payment-method-edit'],
    
    // Employee Management
    'employee-create': ['employee-create', 'employee-edit'],
    'attendance-create': ['attendance-create', 'attendance-edit'],
    'salary-create': ['salary-create', 'salary-edit'],
    'role-create': ['role-create', 'role-edit'],
    ...
    'website-faq-create': ['website-faq-create', 'website-faq-edit'],
    'website-workingprocess-create': ['website-workingprocess-create', 'website-workingprocess-edit'],
    'website-portfolio-create': ['website-portfolio-create', 'website-portfolio-edit'],
  }
  
  // Check if current route is in the create/edit mapping
  if (createEditRouteMap[resolveRoutedName]) {
    return createEditRouteMap[resolveRoutedName].includes(currentRoute.name)
  }
