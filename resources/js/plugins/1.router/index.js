...
router.beforeEach((to, from, next) => {
  ...
  const publicFrontendPages = [
    ...
    "/frontend/team-details/:id",
    "/frontend/faq",
    "/frontend/shopping-cart",
    "/frontend/appointment-service",
    "/frontend/appointment-service/:id",
    "/booking/success",
    "/frontend/not-found"
  ];
  ...
  const customerOnlyPages = [
    ...
    "/frontend/package-order",
    "/frontend/package-details",
    "/frontend/profile-setting"
  ];
  ...
  if (isCustomerOnlyPage) {
    if (!customerAccessToken || !customerData) {
      ...
      return next({ path: "/frontend/login" });
    }
    return next();
  }
