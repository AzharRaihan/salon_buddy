...
<template>
    <VRow>
        <VCol cols="12">
            <VCard :title="$t('Add Booking')">
                <VCardText>
                    <VForm class="mt-3" @submit.prevent="createBooking">
                        <VRow>
                            <!-- Reference Number -->
                            ...
                            <VCol cols="12" md="6" lg="4" class="d-flex align-center">
                                ...
                                <VBtn icon size="small" color="primary" :class="['ms-2', errors.customer_id ? 'mt-minus-4-px' : 'mt-17-px']" @click="showCustomerModal = true">
                            ...
                            <VCol cols="12">
                                ...
                                <VTable class="repeter-form">
                                    <thead>
                                        <tr>
                                            <th class="w-20">{{ $t('Service') }} <span class="required-asterisk">*</span></th>
                                            <th class="w-20">{{ $t('Start Time') }} <span class="required-asterisk">*</span></th>
                                            <th class="w-20">{{ $t('End Time') }} <span class="required-asterisk">*</span></th>
                                            <th class="w-15">{{ $t('Quantity') }} <span class="required-asterisk">*</span></th>
                                            <th class="w-20">{{ $t('Service Seller') }} <span class="required-asterisk">*</span></th>
