...
const createCategory = async () => {
    ...
    try {
        ...
        const res = await $api('/working-processes', {
            method: 'POST',
            body: formData,
            headers: {
...
<template>
    <VRow>
        <VCol cols="12">
            <VCard :title="$t('Add Working Process')">
                <VCardText>
                    <VForm class="mt-3" @submit.prevent="createCategory">
                        <VRow>
                            ...
                            <VCol cols="12" class="d-flex flex-wrap gap-4">
                                ...
                                <VBtn type="button" @click="router.push({ name: 'category' })" color="primary" variant="tonal">
