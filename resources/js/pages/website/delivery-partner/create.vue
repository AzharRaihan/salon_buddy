...
const createDeliveryPartner = async () => {
    ...
    try {
        const res = await $api('/delivery-partners', {
            method: 'POST',
            body: form.value,
...
<template>
    <VRow>
        <VCol cols="12">
            <VCard :title="$t('Add Delivery Partner')">
                <VCardText>
                    <VForm class="mt-3" @submit.prevent="createDeliveryPartner">
                        <VRow>
                            <!-- Name -->
                            ...
                            <VCol cols="12" class="d-flex flex-wrap gap-4">
                                ...
                                <VBtn type="button" @click="router.push({ name: 'website-delivery-partner' })" color="primary" variant="tonal">
