...
<template>
    <div>
        <!-- Stock Summary Cards -->
        <VRow>
            <VCol cols="12" sm="3" class="mb-5">
                <VCard>
                    <VCardText class="d-flex align-center">
                        <VIcon icon="tabler-package" size="32" color="primary" class="me-3" />
                        <div>
                            <div class="text-h6">{{ formatNumber(stockSummary?.total_items) || formatNumber(0) }}</div>
                            <div class="text-body-2 text-medium-emphasis">{{ t('Total Products') }}</div>
                        </div>
                    </VCardText>
                </VCard>
            </VCol>
            ...
            <VCol cols="12" sm="3" class="mb-5">
                <VCard>
                    <VCardText class="d-flex align-center">
                        <VIcon icon="tabler-box" size="32" color="success" class="me-3" />
                        <div>
                            <div class="text-h6">{{ formatNumber(stockSummary?.total_stock) || formatNumber(0) }}</div>
                            <div class="text-body-2 text-medium-emphasis">{{ t('Total Stock') }}</div>
                        </div>
                    </VCardText>
                </VCard>
            </VCol>
            ...
            <VCol cols="12" sm="3" class="mb-5">
                <VCard>
                    <VCardText class="d-flex align-center">
                        <VIcon icon="tabler-currency-dollar" size="32" color="info" class="me-3" />
                        <div>
                            <div class="text-h6">{{ formatAmount(stockSummary?.total_stock_value) || formatAmount(0) }}</div>
                            <div class="text-body-2 text-medium-emphasis">{{ t('Total Stock Value') }}</div>
                        </div>
                    </VCardText>
                </VCard>
            </VCol>
            ...
            <VCol cols="12" sm="3" class="mb-5">
                <VCard>
                    <VCardText class="d-flex align-center">
                        <VIcon icon="tabler-alert-triangle" size="32" color="warning" class="me-3" />
                        <div>
                            <div class="text-h6">{{ formatNumber(stockSummary?.low_stock_items) || formatNumber(0) }}</div>
                            <div class="text-body-2 text-medium-emphasis">{{ t('Low Stock Items') }}</div>
                        </div>
                    </VCardText>
                </VCard>
            </VCol>
