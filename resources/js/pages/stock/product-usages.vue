        ...
        >
            <VCard flat>
                <VCardTitle class="d-flex justify-space-between align-center pa-4">
                    <span>{{ isEditing ? t('Edit Product Usage') : t('Add Product Usage') }}</span>
                        ...
                        <VRow>
                            ...
                            <VCol cols="12">
                                <AppAutocomplete
                                    ...
                                    :error-messages="formErrors.item_id"
                                    @update:model-value="validateItem"
                                    clearable
                                    required
                                />
                            </VCol>
                            ...
                            <VCol cols="12" md="6">
                                ...
                                <AppDateTimePicker
                                    ...
                                    :label="$t('Usage Date')" :required="true"
                                    :placeholder="$t('Select date')" 
                                    :error-messages="formErrors.usage_date"
