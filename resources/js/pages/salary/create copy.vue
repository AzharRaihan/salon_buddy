...
onMounted(async () => {
    try {
        ...
        form.value.items = employees.value.map(employee => ({
            ...
            overtime_rate: employee.overtime_hour_rate || 0,
            overtime_hour: 0,
            additional_amount: 0,
            deduction_amount: 0,
            absent_day: 0,
                            ...
                            <VCol cols="12">
                                ...
                                <VTable>
                                    <thead>
                                        <tr>
                                            <th>{{ t('SN') }}</th>
                                            <th>{{ t('Employee') }} <span class="text-error">*</span></th>
                                            <th>{{ t('Salary Amount') }} <span class="text-error">*</span></th>
                                            <th>{{ t('Overtime Rate') }}</th>
                                            <th>{{ t('Overtime Hour') }}</th>
                                            <th>{{ t('Additional Amount') }}</th>
                                            <th>{{ t('Deduction Amount') }}</th>
                                            <th>{{ t('Absent Days') }}</th>
                                            <th>{{ t('Absent Amount') }}</th>
                                            <th>{{ t('Advance Taken') }}</th>
                                            <th>{{ t('Net Salary') }}</th>
                                            <th>{{ t('Note') }}</th>
                                            <th>{{ t('Action') }}</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr v-for="(item, index) in form.items" :key="item.employee_id">
                                            <td>{{ index + 1 }}</td>
                                            <td>{{ item.employee_name }}</td>
                                            <td>
                                                <AppTextField
                                                    :value="formatNumberPrecision(item.salary_amount)"
                                                    type="number"
                                                    density="compact"
                                                    hide-details
                                            ...
                                            <td>{{ formatNumberPrecision(item.net_salary) }}</td>
                                            <td>
                                                <AppTextField
                                                    v-model="item.note"
                                                    type="text"
